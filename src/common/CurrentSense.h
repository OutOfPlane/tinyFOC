 ...
 */
int CurrentSense_init(struct s_CurrentSense *cs);
 ...
 */
int CurrentSense_driverAlign(struct s_CurrentSense *cs, FIXP align_voltage, bool modulation_centered);
 ...
 */
PhaseCurrent_s CurrentSense_getPhaseCurrents(struct s_CurrentSense *cs);
/**
