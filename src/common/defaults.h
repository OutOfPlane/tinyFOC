...
#define DEF_PID_CURR_LIMIT FIX_FROM_FLOAT(DEF_POWER_SUPPLY) //!< default PID controller voltage limit
...
#define DEF_CURR_FILTER_Tf ((uint32_t)(1e6f/(_2PI*DEF_CURR_BANDWIDTH))) //!< default currnet filter time constant
#endif
// default current limit values
#define DEF_CURRENT_LIM 2.0f //!< 2Amps current limit by default
#define DEF_CURRENT_LIM_FIXP FIX_FROM_FLOAT(DEF_CURRENT_LIM) //!< 2Amps current limit by default
...
#define DEF_VEL_LIM_FIXP FIX_FROM_FLOAT(DEF_VEL_LIM) //!< angle velocity limit default
